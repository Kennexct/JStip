  ...
  useEffect(() => {
    async function loadDashboardData() {
      try {
        ...
        toast.error('Failed to load live data from database');
      } finally {
        setLoading(false);
      }
    }
                    ...
                    <div className="p-3 bg-indigo-50/70 border border-indigo-150 border-indigo-100 rounded-xl space-y-1.5 mt-1.5">
                      ...
                      <Button 
                        ...
                        onClick={async () => {
                          ...
                          try {
                            await db.saveWishlist(newWish);
                            setWishlistItems([newWish, ...wishlistItems]);
                            ...
                            setCatalogItems([...catalogItems, newCatItem]);
