...
export const db = {
  ...
  async getWishlist(): Promise<any[]> {
    ...
    const defaultWishlist = [
      { id: 'w1', name: 'Aesop Resurrection Hand Balm', requester: 'Jane D.', status: 'found', price: 450000, location: 'Melbourne', image: 'https://images.unsplash.com/photo-1626015276681-28516e744f97?w=120&auto=format&fit=crop&q=60' },
      { id: 'w2', name: 'Nike Dunk Low Panda', requester: 'Mike R.', status: 'find', price: 1850000, location: 'Japan', image: 'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?w=120&auto=format&fit=crop&q=60' },
      { id: 'w3', name: 'Anua Heartleaf Soothing Toner', requester: 'Sarah L.', status: 'found', price: 285000, location: 'Seoul', image: 'https://images.unsplash.com/photo-1608248597481-496100c80836?w=120&auto=format&fit=crop&q=60' },
    ];
    ...
    const defaultSales = [
      {
        ...
        items: [{ productId: '1', name: 'Anua Heartleaf Toner', price: 285000, qty: 2 }],
        total: 570000,
        date: '10:45 AM'
      }
    ];
  ...
  async getExpenses(): Promise<any[]> {
    ...
    const defaultExpenses = [
      { id: 'exp_init_1', description: 'Grab Car to Myeongdong Mall', amount: 160000, category: 'Transport', date: '08:30 AM', originalAmount: 13700, originalSymbol: '₩' },
      { id: 'exp_init_2', description: 'N Seoul Tower Tax Custom Duty', amount: 85000, category: 'Tax/Duty', date: '02:15 PM', originalAmount: 7260, originalSymbol: '₩' },
    ];
